...
CANDIDATE_OVERRIDES = {
    "BRKB": "BRK-B",
    "HK0700": "0700.HK",       # Tencent HKEX 700
    "HK1810": "1810.HK",       # Xiaomi HKEX 1810
    "MEITUAN": "3690.HK",
    "KUAISHOU": "1024.HK",
    "POPMART": "9992.HK",
    "SKHYNIX": "000660.KS",
...
# Known pre-IPO / AI-lab marks: no listed underlying can exist. Recorded so the
# join marks them no-underlying rather than flagged.
EXPECTED_NO_UNDERLYING = {"OPENAI", "ANTHROPIC", "SPCX", "ZHIPU", "MINIMAX"}
